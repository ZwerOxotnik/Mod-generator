...
echo -- More info: https://www.reddit.com/r/ZwerOxotnik/comments/dv7tpx/you_want_your_own_mod_stay_tuned/ >> %SOUNDS_LIST_FILE%
...
echo	path = "__your-mod-name__/this-folder-name/", -- path to this folder >> %SOUNDS_LIST_FILE%
